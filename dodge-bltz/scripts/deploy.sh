...
WAX_TESTNET_URL="https://testnet.waxsweden.org"

echo "🚀 Deploying Dodge BLTZ to WAX Testnet..."
...
echo "🔧 Setting up cleos for WAX testnet..."
alias cleos="cleos -u $WAX_TESTNET_URL"
